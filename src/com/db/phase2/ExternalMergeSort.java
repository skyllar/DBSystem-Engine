...
public class ExternalMergeSort {
	...
	public void initialiseMerge(String folderPath,String filename,String finalfile,String tableName,TOrderByItemList tOrderByItemList,HashMap<String,Integer> hmp ){
		int i,j;
		...
		try{
			...
			for (i = 0 ; i < fragments; i++){
				set.add(i);
                file[i]=new FileReader( folderPath +"/"+filename+Integer.toString(i));
                del[i] = new File(folderPath + "/"+filename+Integer.toString(i));
